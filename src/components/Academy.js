...
const Academy = () => {
	...
	<img src={require("./images/logo.svg").default} alt="Qik.ai" className="img-logovs" /></a> </div>
		  ...
		  <nav className="nav-menu d-none d-lg-block float-right">   <ul >
		  ...
		  <a  href="#qik-intro">Home</a> 
			...
			<li  >
			<a  href="#qik-products" >Products</a></li>
			  <li  >
              <a  href="#customer">Our Customers</a></li>
			  <li  >
              <a   href="#qik-pricing">Pricing</a></li>
				<li  >
	  ...
	  <div className="container">
		<div className="row">
		  <div className="col-md-5 introtext">
			<h2>Let's manage your <br />academy just a few<br />clicks
			  <hr className="section-line-border mhide" />	 <hr className="section-line-border1 mshow" /></h2>
			<p> Make your academy digital by bringing all the <br />stakeholders - students, parents, teachers and<br /> management on a signle platform. </p>
			<a href="#qik-products" className="btn btn-primary btn-lg" style={{marginBottom: '40px', borderRadius: '4px'}}>Get Business App</a> 
		  </div>		
		  <div className="col-md-7">
			<img src={require("./images/academy-intro.png")} className="img-fluid" width="100%" alt="" /> <br /><br /><h5 style={{textAlign: 'center'}}>Qik Academy Software</h5>
	  ...
	  <div className="container">
		<div className="row"> 
		  ...
		  <div className="col-md-8">
			...
			<h2>Simple &amp; reliable suit of <br />application to run your<br /> academy <hr className="section-line-border" /></h2>
			<p>The exceptional cloud-based solution for academy management with student records management such as results,
			  homework &amp; fess. SMS updates to parents &amp; students for free reminder. test results &amp; holidays. Other
			  important features such as print I-cards, progress reports of students &amp; 
			  <a href="http://www.qik.ai/Business" >		Many more</a><br /><br /><small><a href="http://www.qik.ai/go/elearning/">Qik E-Learning App
			  </a></small></p>
		  </div>
		  ...
		  <div className="row text-center uvs-boxes"><div className="uvs-line-h" />
			...
			<div className="col-md-12 text-center">
			  <a href="#qik-pricing" className="btn btn-primary btn-lg" id="customer" style={{margin: '40px 0', borderRadius: '4px', width: '216px', textAlign: 'center'}}>Buy Now</a> 
			</div>
		  </div>
		</div>
	  </div></section> 
	  ...
	  <div className="container">
		<div className="row"> 
		  <div className="col-md-12">
			...
			<h2>What our customers <br />are saying <hr className="section-line-border" /></h2></div> 
		...
		</div> </div><div style={{background: '#eeeeee54'}}>     <div className="container"> 
				...
				<div className="row">
				  ...
				  <div className="col-md-8">
					...
					<div className="class-desript"><h3>Samruddhi Patil</h3><p>We have taken Drona Academy Software 
						...
						available for any help or service. We highly recommend Drona Academy Software to other Academy 
						as well.</p>
					  <p className="text-t-color">- Brain Booster Academy (MD)</p></div></div></div></div>
          </div>
	...
	<section id="qik-pricing" className="qik-pricing">
	  <div className="container">
		<div className="row">
		  <div className="col-md-12" style={{textAlign: 'center', marginBottom: '7%'}}>
			<span className="uvs-span">Pricing</span>
			<h2>App subscription <hr className="section-line-border1" style={{background: '#00abf6'}} /></h2>
		  </div>
		  <div className="col-md-12">
			<div className="row">
			  <div className="col-md-4">
				<div className="uvs-classics"><table className="uvs-table"> <caption>Customize Pack 1<br /><span className="uvs-lines" /></caption>
					<tbody><tr><td> <span style={{color: '#00abf6'}}>50% discount</span>&nbsp;&nbsp;&nbsp; <strong><strike>$999</strike></strong> </td></tr>
					  <tr><td><h2>$450</h2> Per Month</td></tr> 
					  <tr><td><i className="fa fa-check" aria-hidden="true" />It is a long established fact that </td></tr>
					  <tr><td><i className="fa fa-check" aria-hidden="true" />It is a long established fact that </td></tr>
					  <tr><td><i className="fa fa-check" aria-hidden="true" />It is a long established fact that </td></tr>
					  <tr><td><i className="fa fa-check" aria-hidden="true" />It is a long established fact that </td></tr>
					  <tr><td><i className="fa fa-check" aria-hidden="true" />It is a long established fact that </td></tr>
					  <tr><td className="select-td"> 
						  <a href="JavaScript:Void(0);" className="btn btn-uvs">Choose Plan &nbsp;&nbsp; <i className="fa fa-angle-right"> </i><i className="fa fa-angle-right"> </i> </a>
						</td></tr>
					</tbody></table>
				</div>
			  </div>
			  <div className="col-md-4">
				<div className="uvs-classics-vs"><table className="uvs-table"> 
					<caption style={{color: '#fff'}}>Annual Pack 3<br /><span className="uvs-linevs" /></caption>	 
					<tbody><tr><td> <h2 style={{color: '#fff'}}>$990</h2> Per Month</td></tr> 
					  <tr><td><i className="fa fa-check" aria-hidden="true" />It is a long established fact that </td></tr>
					  <tr><td><i className="fa fa-check" aria-hidden="true" />It is a long established fact that </td></tr>
					  <tr><td><i className="fa fa-check" aria-hidden="true" />It is a long established fact that </td></tr>
					  <tr><td><i className="fa fa-check" aria-hidden="true" />It is a long established fact that </td></tr>
					  <tr><td><i className="fa fa-check" aria-hidden="true" />It is a long established fact that </td></tr>
					  <tr><td className="select-td">
						  <a href="JavaScript:Void(0);" className="btn btn-primary">Choose Plan &nbsp;&nbsp; <i className="fa fa-angle-right"> </i><i className="fa fa-angle-right"> </i> </a>
						</td></tr>
					</tbody></table>
				</div>
			  </div>
			  <div className="col-md-4">
				<div className="uvs-classics"><table className="uvs-table"> <caption>Customize Pack 4 <br /><span className="uvs-lines" /></caption>
					<tbody><tr><td> <span style={{color: '#00abf6'}}>50% discount</span>&nbsp;&nbsp;&nbsp; <strong><strike>$999</strike></strong> </td></tr>
					  <tr><td><h2>$450</h2> Per Month</td></tr> 
					  <tr><td><i className="fa fa-check" aria-hidden="true" />It is a long established fact that </td></tr>
					  <tr><td><i className="fa fa-check" aria-hidden="true" />It is a long established fact that </td></tr>
	  ...
	  <div className="container">
		<div className="row">
		  ...
		  <div className="col-md-6"><div className="form-uvsl"> <br /><br />Name <input type="text" name="name" className="form-control" />
			  ...
			  Mobile Number <input type="text" name="name" className="form-control" />
			  Description <textarea className="form-control" defaultValue={""} />		 <input type="submit" className="btn btn-primary btn-lg" text="Submit" style={{width: '216px', textAlign: 'center'}} />
			</div></div>
		</div>
	  </div>
	</section> 
