 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(P,z){var L=P.length;P.push(z);e:for(;0<L;){var V=L-1>>>1,q=P[V];if(0<l(q,z))P[V]=z,P[L]=q,L=V;else break e}}function n(P){return P.length===0?null:P[0]}function r(P){if(P.length===0)return null;var z=P[0],L=P.pop();if(L!==z){P[0]=L;e:for(var V=0,q=P.length,ur=q>>>1;V<ur;){var wt=2*(V+1)-1,Rl=P[wt],kt=wt+1,cr=P[kt];if(0>l(Rl,L))kt<q&&0>l(cr,Rl)?(P[V]=cr,P[kt]=L,V=kt):(P[V]=Rl,P[wt]=L,V=wt);else if(kt<q&&0>l(cr,L))P[V]=cr,P[kt]=L,V=kt;else break e}}return z}function l(P,z){var L=P.sortIndex-z.sortIndex;return L!==0?L:P.id-z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var o=Date,a=o.now();e.unstable_now=function(){return o.now()-a}}var c=[],u=[],m=1,h=null,g=3,w=!1,y=!1,v=!1,k=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(P){for(var z=n(u);z!==null;){if(z.callback===null)r(u);else if(z.startTime<=P)r(u),z.sortIndex=z.expirationTime,t(c,z);else break;z=n(u)}}function x(P){if(v=!1,p(P),!y)if(n(c)!==null)y=!0,bl(S);else{var z=n(u);z!==null&&zl(x,z.startTime-P)}}function S(P,z){y=!1,v&&(v=!1,f(b),b=-1),w=!0;var L=g;try{for(p(z),h=n(c);h!==null&&(!(h.expirationTime>z)||P&&!de());){var V=h.callback;if(typeof V=="function"){h.callback=null,g=h.priorityLevel;var q=V(h.expirationTime<=z);z=e.unstable_now(),typeof q=="function"?h.callback=q:h===n(c)&&r(c),p(z)}else r(c);h=n(c)}if(h!==null)var ur=!0;else{var wt=n(u);wt!==null&&zl(x,wt.startTime-z),ur=!1}return ur}finally{h=null,g=L,w=!1}}var _=!1,E=null,b=-1,F=5,R=-1;function de(){return!(e.unstable_now()-R<F)}function mn(){if(E!==null){var P=e.unstable_now();R=P;var z=!0;try{z=E(!0,P)}finally{z?gn():(_=!1,E=null)}}else _=!1}var gn;if(typeof d=="function")gn=function(){d(mn)};else if(typeof MessageChannel<"u"){var Zs=new MessageChannel,Uc=Zs.port2;Zs.port1.onmessage=mn,gn=function(){Uc.postMessage(null)}}else gn=function(){k(mn,0)};function bl(P){E=P,_||(_=!0,gn())}function zl(P,z){b=k(function(){P(e.unstable_now())},z)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){y||w||(y=!0,bl(S))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function(P){switch(g){case 1:case 2:case 3:var z=3;break;default:z=g}var L=g;g=z;try{return P()}finally{g=L}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,z){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var L=g;g=P;try{return z()}finally{g=L}},e.unstable_scheduleCallback=function(P,z,L){var V=e.unstable_now();switch(typeof L=="object"&&L!==null?(L=L.delay,L=typeof L=="number"&&0<L?V+L:V):L=V,P){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=L+q,P={id:m++,callback:z,priorityLevel:P,startTime:L,expirationTime:q,sortIndex:-1},L>V?(P.sortIndex=L,t(u,P),n(c)===null&&P===n(u)&&(v?(f(b),b=-1):v=!0,zl(x,L-V))):(P.sortIndex=q,t(c,P),y||w||(y=!0,bl(S))),P},e.unstable_shouldYield=de,e.unstable_wrapCallback=function(P){var z=g;return function(){var L=g;g=z;try{return P.apply(this,arguments)}finally{g=L}}}})(Ra);za.exports=Ra;var pd=za.exports;/**
 * @license React
